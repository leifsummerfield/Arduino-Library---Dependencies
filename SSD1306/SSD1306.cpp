...
// Invert a line of displayed characters.  Added by Russ Crowther 08/22/2012

void  SSD1306::invertlineofchar(uint8_t line) {
  if (line >= SSD1306_LCDHEIGHT/8)
      return;
  for (uint16_t i =line*128; i<line*128+128; i++ ) {
    buffer[i] = !buffer[i] ;
  }
}
